...
def patchShow(images, out_range=(0.,1.), in_range=None, rows=0, cols=0):
    """
    Concatenate all the images and do normalization uniformly
    """
    num = images.shape[0]
    ih = images.shape[2]
    iw = images.shape[3]
...
def patchShow_no_norm(images, out_range=(0.,1.), in_range=None, rows=0, cols=0):
    """
    Concatenate all the images but without normalization(compare to patchShow)
    """
    num = images.shape[0]
    ih = images.shape[2]
    iw = images.shape[3]
